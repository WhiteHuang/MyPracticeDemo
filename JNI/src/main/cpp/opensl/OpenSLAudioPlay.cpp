...
//
//#define LOGI(FORMAT, ...) __android_log_print(ANDROID_LOG_INFO,"MyPracticeDemo",FORMAT,##__VA_ARGS__);
//#define LOGE(FORMAT, ...) __android_log_print(ANDROID_LOG_ERROR,"MyPracticeDemo",FORMAT,##__VA_ARGS__);
//
